/*
  ...
  - You are about to drop the column `supplierComent` on the `Book` table. All the data in the column will be lost.
...
INSERT INTO "new_Book" ("additionalMaterial", "author", "createdAt", "dueDate", "editionDescription", "id", "imageLink", "isbn", "maxAge", "minAge", "minPlayers", "otherPhysicalAttributes", "pages", "physicalSize", "price", "publisherDate", "publisherLocation", "publisherName", "renewalCount", "rentalStatus", "rentedDate", "subtitle", "summary", "title", "topics", "updatedAt", "userId") SELECT "additionalMaterial", "author", "createdAt", "dueDate", "editionDescription", "id", "imageLink", "isbn", "maxAge", "minAge", "minPlayers", "otherPhysicalAttributes", "pages", "physicalSize", "price", "publisherDate", "publisherLocation", "publisherName", "renewalCount", "rentalStatus", "rentedDate", "subtitle", "summary", "title", "topics", "updatedAt", "userId" FROM "Book";
DROP TABLE "Book";
